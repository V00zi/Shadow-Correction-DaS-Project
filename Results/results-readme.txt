...
1. delisted_trends_output.csv

	This file contains the results from google trends query of the games that were sampled the data file. Unstructured output, crude
